...
# --- 2. DỮ LIỆU NHÓM SỐ (FIX LỖI LEADING ZEROS) ---
...
def cap_nhat_logic():
    ...
    # Tính hạng trước khi update khan
    res_list = []
    for i in range(100):
...
with c3: st.number_input("Ky quay (full so):", value=st.session_state.ky_quay, key="ky_quay", step=1)
